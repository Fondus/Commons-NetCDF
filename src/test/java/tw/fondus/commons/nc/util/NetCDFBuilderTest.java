...
public class NetCDFBuilderTest {
	...
	public void test() throws IOException, InvalidRangeException {
		...
		NetCDFBuilder.create(new File("src/test/resources/test.nc").getPath())
				...
				.addVariableAttribute("y", VariableAttribute.KEY_NAME_LONG, "y coordinate according to WGS 1984")
				...
				.addVariableAttribute("x", VariableAttribute.KEY_NAME_LONG, "x coordinate according to WGS 1984")
